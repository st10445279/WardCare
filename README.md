...
1. Clone the repository and open it in Android Studio (Ladybug or newer recommended).
2. Let Gradle sync — the project uses AGP 8.7.2 and Kotlin 2.0.21.
3. Run on an emulator or device with API level 24+.

## Video demo

The video is in zipped folder "WardCare video.zip"
